...
public class MainFrame extends JFrame {
	...
	private Action newTask = new AbstractAction("新任务",
	...
	private Action start = new AbstractAction("开始",
	...
	private Action pause = new AbstractAction("暂停",
	...
	private Action delete = new AbstractAction("删除任务",
	...
	private Action deleteFinished = new AbstractAction("删除任务",
	...
	private Action sysSetting = new AbstractAction("系统设置",
	...
	private Action aboutWindow = new AbstractAction("关于我们", ImageUtil.ABOUT) {
	...
	public MainFrame() {
		...
		// 30));
		// 窗体尺寸：1330*0.618=822 1330-822=508 850*0.618=525 850-525=325
		// 宽和高
		int width = 0;
		int height = 0;
		...
		/*
		 * 设置初始位置 (screen.width - 1330) / 2 (screen.high - 850) / 2
		 */
		this.setLocation((screen.width - width) / 2, (screen.height - height) / 2);
		this.setVisible(true);
		this.setTitle("Internet Download Kits下载套件 v1.0 Bata");
	...
	private void createToolBar() {
		...
		this.toolBar.add(this.sysSetting).setToolTipText("系统设置");
		this.toolBar.add(this.aboutWindow).setToolTipText("关于我们");
	...
	private void delete() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "资源被系统占用，请重启软件后重试！", "错误", JOptionPane.ERROR_MESSAGE);
		}
		// 从上下文集合中删除资源
